...
import cst8218.jasa0008.entity.SpriteFacade;
...
/**
 * This class runs the sprite game logic. It moves sprites and can create new ones.                                      
 * @author Nathan Denyer
 * @version 1
 * @since 1.8
 * @see Sprite, AbstractFacade, SpriteFacade
 */
@Singleton
